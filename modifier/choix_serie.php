    ...
    <div class="row">
        ...
        <div class="col-md-10 content">
            <div class="card m-3 text-center">
                <h1 style="color:#0d6efd">Modifier Serie</h1>
                <div class="card-body">
                    <?php
                            ...
                            <table id="myTable" class="table table-striped table-sm text-center display">
                                ...
                                <tbody>
                                    ...
                                    foreach ($rowSerie as $serie) {
                                        ...
                                        echo "<td><form action='../modifier/serie.php' method='post'><input type='hidden' name='serie' value='".$serie['Id']."' ><button type='submit' class='btn btn-primary'>Modifier</button></form></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                                </tbody>
