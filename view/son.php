    ...
    <div class="row">
        ...
        <div class="col-md-10 content">
            <div class="card m-3 text-center">
                <h1 style="color:#0d6efd">Liste des sons</h1>
                <div class="card-body">
                    <?php
                        ...
                        <tbody>
                            ...
                            foreach ($row as $son) {
                                ...
                                echo "<td class='align-middle'>
                                        <form action='../modifier/son.php' method='post' style='display: inline-block; margin-right: 10px;float-left'>
                                            <input type='hidden' name='son' value='" . $son['Id'] . "'>
                                            <button type='submit' class='btn btn-primary'>Modifier</button>
                                        </form>
                                        <form action='../controller/supprimer.php' method='post' style='display: inline-block;float-left' onsubmit='return confirmSubmit(\"" . $son['Intitule'] . "\")'>
                                            <input type='hidden' name='son' value='" . $son['Id'] . "'>
...
<script>
    ...
    function confirmSubmit(intitule) {
        return confirm("Êtes-vous sûr de vouloir supprimer le son " + intitule + " ?");
    }
</script>